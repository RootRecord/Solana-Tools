...
ROOTS_MINT_ADDRESS = pubkey_from_env("ROOTS_MINT_ADDRESS", required=True)
ROOTS_OWNER_WALLET = pubkey_from_env("ROOTS_OWNER_WALLET", required=True)
ROOTS_DESTINATION_WALLET = pubkey_from_env("ROOTS_DESTINATION_WALLET", str(ROOTS_OWNER_WALLET))
ROOTS_NEW_AUTHORITY = pubkey_from_env("ROOTS_NEW_AUTHORITY", str(ROOTS_OWNER_WALLET))

ROOTS_TOKENS_TO_MINT = env_int("ROOTS_TOKENS_TO_MINT", 100)
ROOTS_TOKEN_DECIMALS = env_int("ROOTS_TOKEN_DECIMALS", 9)
ROOTS_UNFREEZE_ACCOUNTS = env_list("ROOTS_UNFREEZE_ACCOUNTS")
